...
import { contentProviderRegistry, type HeaderDocDefinition } from '../../content';
...
export default function ContentDrawer() {
  ...
  const resolution = useMemo(
    () => (activeContentId ? contentProviderRegistry.resolveContent({ contentId: activeContentId }) : null),
    [activeContentId],
  );
