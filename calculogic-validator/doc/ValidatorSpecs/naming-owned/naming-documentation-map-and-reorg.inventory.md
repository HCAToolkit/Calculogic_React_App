...
| `calculogic-validator/doc/ValidatorSpecs/cross-cutting/naming-bridge-occurrence-identity-contract.spec.md` | Cross-cutting occurrence identity contract for future address-keyed Naming bridge evidence | **Bounded normative supporting spec** (cross-slice bridge contract lane) | Naming bridge implementation tasks; read before the Naming-owned observation-rules spec for bridge envelope, identity tuple, inheritance semantics, and ownership boundaries | **Stay put in `cross-cutting/`** because occurrence identity spans Addressing, Naming, Tree, and suite-core transport | **Reference before child Naming bridge observation rules** |
| `calculogic-validator/doc/ValidatorSpecs/naming-owned/naming-address-attached-bridge-observation-rules.spec.md` | Naming-owned rules for future address-attached bridge observations | **Bounded normative supporting spec** (Naming-owned child bridge contract) | Naming bridge implementation tasks after reading the parent occurrence identity contract | **Stay in `naming-owned/`** because it defines Naming-owned semantic observation rules | **Keep in `naming-owned/`; do not merge occurrence identity or Tree conclusions into Naming** |
